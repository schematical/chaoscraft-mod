...
public class PostSimmodelsResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public PostSimmodelsResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PostSimmodelsResult == false)
            return false;
        PostSimmodelsResult other = (PostSimmodelsResult) obj;
    ...
    @Override
    public PostSimmodelsResult clone() {
        try {
            return (PostSimmodelsResult) super.clone();
