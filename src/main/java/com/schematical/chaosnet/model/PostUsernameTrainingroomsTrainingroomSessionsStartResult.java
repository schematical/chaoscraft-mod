...
public class PostUsernameTrainingroomsTrainingroomSessionsStartResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public PostUsernameTrainingroomsTrainingroomSessionsStartResult trainingRoomSession(TrainingRoomSession trainingRoomSession) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PostUsernameTrainingroomsTrainingroomSessionsStartResult == false)
            return false;
        PostUsernameTrainingroomsTrainingroomSessionsStartResult other = (PostUsernameTrainingroomsTrainingroomSessionsStartResult) obj;
    ...
    @Override
    public PostUsernameTrainingroomsTrainingroomSessionsStartResult clone() {
        try {
            return (PostUsernameTrainingroomsTrainingroomSessionsStartResult) super.clone();
