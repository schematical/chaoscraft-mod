...
public class PostAuthTokenResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public PostAuthTokenResult authLoginResponse(AuthLoginResponse authLoginResponse) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PostAuthTokenResult == false)
            return false;
        PostAuthTokenResult other = (PostAuthTokenResult) obj;
    ...
    @Override
    public PostAuthTokenResult clone() {
        try {
            return (PostAuthTokenResult) super.clone();
