...
public class GetUsernameResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public GetUsernameResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetUsernameResult == false)
            return false;
        GetUsernameResult other = (GetUsernameResult) obj;
    ...
    @Override
    public GetUsernameResult clone() {
        try {
            return (GetUsernameResult) super.clone();
