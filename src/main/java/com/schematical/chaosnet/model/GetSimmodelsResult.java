...
public class GetSimmodelsResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public GetSimmodelsResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSimmodelsResult == false)
            return false;
        GetSimmodelsResult other = (GetSimmodelsResult) obj;
    ...
    @Override
    public GetSimmodelsResult clone() {
        try {
            return (GetSimmodelsResult) super.clone();
