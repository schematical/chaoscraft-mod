...
*/
package com.schematical.chaosnet.auth;
 ...
 * this can to be supplied during construction of a {@link ChaosNet} via
 * {@link ChaosNetClientBuilder#signer(ChaosnetCognitoUserPool)} like so
 *
 * <pre>
 * <code>
 *  ChaosNet client = ChaosNet.builder().signer((ChaosnetCognitoUserPool) request -> "some token").build();
 * </code>
 * </pre>
 */
@FunctionalInterface
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public interface ChaosnetCognitoUserPool extends RequestSigner {
