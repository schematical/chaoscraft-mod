...
import com.schematical.chaosnet.model.PostUsernameTrainingroomsTrainingroomSessionsSessionNextRequest;
import com.schematical.chaosnet.model.PostUsernameTrainingroomsTrainingroomSessionsSessionNextResult;
import com.schematical.chaosnet.model.TrainingRoomSessionNextReport;
import com.schematical.chaosnet.model.TrainingRoomSessionNextRequest;
...
public class ChaosThread implements Runnable {
  ...
  public void run() {
    ...
    try {
      ...
      PostUsernameTrainingroomsTrainingroomSessionsSessionNextResult result = ChaosCraft.sdk
          .postUsernameTrainingroomsTrainingroomSessionsSessionNext(request);
      ...
      String message = StandardCharsets.UTF_8.decode(byteBuffer)
          .toString();//new String(byteBuffer.as().array(), StandardCharsets.UTF_8 );
      ...
      ChaosCraft.chat(
          "ChaosThread `/next` Error: " + exception.getMessage() + " - exception type: " + exception
              .getClass().getName());
      ChaosCraft.thread = null;
