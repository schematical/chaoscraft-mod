...
public class CommandChaosCraftHardReset extends CommandBase {
   ...
   /* public int getRequiredPermissionLevel() {
    ...
    public void execute(MinecraftServer p_execute_1_, ICommandSender p_execute_2_, String[] args) throws CommandException {
        try{
            ...
            PostUsernameTrainingroomsTrainingroomSessionsStartResult response = ChaosCraft.sdk.postUsernameTrainingroomsTrainingroomSessionsStart(request);
