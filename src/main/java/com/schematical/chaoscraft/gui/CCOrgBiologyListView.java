...
public class CCOrgBiologyListView extends CCGuiBase {
    ...
    public class CCBiologyDetailButton extends CCGuiButton{
        ...
        public CCBiologyDetailButton(int x, int y, int z, int buttonWidth, int buttonHeight, String s, ButtonAction viewBiologyDetailAction, EntityOrganism entityOrganism, BiologyBase _biologyBase) {
