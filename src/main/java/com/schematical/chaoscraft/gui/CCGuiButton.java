...
public class CCGuiButton extends GuiButton {
    ...
    public CCGuiButton(int buttonId, int x, int y, int width, int height, String buttonText, CCGuiBase.ButtonAction action) {
        this(buttonId, x, y, width, height, buttonText);
        this.action = action;
    }

    public CCGuiButton(int buttonId, int x, int y, int width, int height, String buttonText, CCGuiBase.ButtonAction action, EntityOrganism entity) {
