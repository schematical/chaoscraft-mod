...
public class CCSpeciesListView extends CCGuiBase {
  ...
  public CCSpeciesListView() {
    ...
    GetUsernameTrainingroomsTrainingroomSessionsSessionSpeciesResult result = ChaosCraft.sdk
        .getUsernameTrainingroomsTrainingroomSessionsSessionSpecies(request);
